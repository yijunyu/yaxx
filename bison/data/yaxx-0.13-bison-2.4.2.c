...
union yyalloc
{
  ...
  YYSTYPE yyvs_alloc;]b4_yaxx([char *yyxs_alloc;])[
...
b4_c_function_def([[yypush_parse]], [[int]],
  ...
  [[[YYLTYPE const *yypushed_loc]], [[yypushed_loc]]]])])m4_ifset([b4_parse_param], [,
  b4_parse_param]))], [
]b4_yaxx([extern char *b4_prefix[]text;])[
#ifdef YYPARSE_PARAM
  ...
  *yyssp = yystate;
  ...
  if (yyss + yystacksize - 1 <= yyssp)
	...
	/* Give user a chance to reallocate the stack.  Use copies of
	   ...
	   memory.  */
	YYSTYPE *yyvs1 = yyvs;
	yytype_int16 *yyss1 = yyss;]b4_yaxx([
        char **yyxs1 = yyxs;])[
]b4_locations_if([
	YYLTYPE *yyls1 = yyls;])[
	...
	yyoverflow (YY_("memory exhausted"),
		    ...
		    &yyvs1, yysize * sizeof (*yyvsp),]b4_yaxx([
		    &yyxs1, yysize * sizeof (*yyxsp),])[]b4_locations_if([
...
# else
	...
	YYSTACK_RELOCATE (yyvs_alloc, yyvs);]b4_yaxx([
	YYSTACK_RELOCATE (yyxs_alloc, yyxs);])[]b4_locations_if([
...
# endif
      ...
      yyssp = yyss + yysize - 1;
      yyvsp = yyvs + yysize - 1;]b4_yaxx([
      yyxsp = yyxs + yysize - 1;])[]b4_locations_if([
      yylsp = yyls + yysize - 1;])[
