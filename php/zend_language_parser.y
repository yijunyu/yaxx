...
/* $Id: zend_language_parser.y,v 1.1 2006/09/14 19:32:15 yijunsf Exp $ */
...
aspect_statement:
	...
	|	T_BEFORE aspect_pointcut '{' inner_statement_list '}'
	|	T_AROUND aspect_pointcut '{' inner_statement_list '}'
	|	T_AFTER  aspect_pointcut '{' inner_statement_list '}'
	/*|       method_modifiers T_FUNCTION is_reference aspect_class_signature aspect_subtype_or_not T_PAAMAYIM_NEKUDOTAYIM T_STRING '(' parameter_list ')' method_body*/
;
...
aspect_joinpoint:
		T_STRING
	|	T_CALL  '(' aspect_signature aspect_call aspect_signature '(' aspect_parameters ')' ')'
	|	T_EXEC  '(' method_modifiers T_FUNCTION is_reference aspect_signature aspect_subtype_or_not '(' aspect_parameters ')' ')'
	|	T_NEW   '('aspect_signature '(' aspect_parameters ')' ')'
...
aspect_variable_introduction:
		aspect_variable_introduction ',' aspect_class_signature aspect_subtype_or_not T_PAAMAYIM_NEKUDOTAYIM T_VARIABLE
	|	aspect_variable_introduction ',' aspect_class_signature aspect_subtype_or_not T_PAAMAYIM_NEKUDOTAYIM T_VARIABLE '=' static_scalar
	|	aspect_class_signature aspect_subtype_or_not T_PAAMAYIM_NEKUDOTAYIM T_VARIABLE
	|	aspect_class_signature aspect_subtype_or_not T_PAAMAYIM_NEKUDOTAYIM T_VARIABLE '=' static_scalar
;

/* added by William Candillon <wcandillon@php.net> */
aspect_constant_introduction:
		aspect_constant_introduction ',' aspect_class_signature aspect_subtype_or_not T_PAAMAYIM_NEKUDOTAYIM T_STRING '=' static_scalar
	|	T_CONST aspect_class_signature aspect_subtype_or_not T_PAAMAYIM_NEKUDOTAYIM T_STRING '=' static_scalar
;


/* added by William Candillon <wcandillon@php.net> */
aspect_class_signature:
		aspect_class_signature ',' aspect_signature
	|	aspect_signature
;
